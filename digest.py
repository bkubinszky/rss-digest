from config import RSS_FEEDS, YOUR_INTERESTS, EMAIL_FROM, EMAIL_PASSWORD, EMAIL_TO, SOURCE_SCORE_THRESHOLD
...
if __name__ == "__main__":
    ...
    if not fetched_count:
        ...
        # ── 3. Analyze ────────────────────────────────────────────────────────
        print(f"\n[3/4] {fetched_count} Artikel zur Analyse senden...")
        ...
        # ── 4. Format + Send + Log ────────────────────────────────────────────
        print("\n[4/4] E-Mail formatieren und senden...")

        if all_errors and filtered_count == 0:
        ...
        log_entry = build_log_entry(
            ...
            deduped_count  = filtered_count,  # no dedup in v4
